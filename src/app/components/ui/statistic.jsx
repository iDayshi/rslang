    ...
    <section>
      <div className="row">
        <div className="col-12 mt-3 mb-1">
          <h5 className="text-uppercase">Cтатистика {name}</h5>
        </div>
      </div>
      <div className="row">
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex justify-content-between px-md-1">
                ...
                <div className="text-end">
                  <h3 className="text-info">56%</h3>
                  <p className="mb-0">Процент правильных ответов</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between px-md-1">
                ...
                <div className="text-end">
                  ...
                  <p className="mb-0">Серия правильных ответов</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between px-md-1">
                ...
                <div className="text-end">
                  ...
                  <p className="mb-0">Игр сыграно</p>
                </div>
              </div>
            </div>
          </div>
