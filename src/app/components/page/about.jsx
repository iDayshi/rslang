      ...
      <div className="about_wrapper">
        ...
        <section className="about-info">
          ...
          <div className="info-wrapper">
            ...
            <article className="article-wrapper">
              <p>Мини-игра <b>Аудиовызов</b> Развивает навык аудирования. Необходимо отгадать максимальное количество озвученных диктором слов. Для ответа используйте мышь, либо цифры 1 - 5 на клавиатуре. Пропустить слово - пробел, перейти к следующему вопросу - «Enter». Большая круглая кнопка повторит слово, а маленькая - озвучит пример. </p>
            </article>
            <article className="article-wrapper">
              <p>Мини-игра <b>Спринт</b> Развивает скорость перевода. За отведенное время нужно дать как можно больше правильных ответов. Необходимо отгадать, правильно ли предложен перевод слова. </p>
              </article>
          </div>
